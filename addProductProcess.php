...
if ($category == "0") {
    ...
    $mhb_rs = Database::search("SELECT * FROM `brand_has_model` WHERE `model_model_id`='" . $model . "' AND `brand_brand_id`='" . $brand . "'");
    ...
    if ($mhb_rs->num_rows > 0) {
        ...
        Database::iud("INSERT INTO `brand_has_model`(`model_model_id`,`brand_brand_id`) VALUES ('" . $model . "','" . $brand . "')");
    ...
    `delivery_fee_other`,`category_cat_id`,`brand_has_model_id`,`color_color_id`,`status_status_id`,`condition_condition_id`,`users_email`) 
