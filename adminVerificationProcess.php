...
if(isset($_POST["e"])){
    ...
    if($admin_num > 0){
        ...
        $mail = new PHPMailer;
            ...
            $mail->Password = 'xckkbkzhpovnzgxx';
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('dakalankagunasekara2003@gmail.com', 'Admin Verification');
            $mail->addReplyTo('dakalankagunasekara2003@gmail.com', 'Admin Verification');
