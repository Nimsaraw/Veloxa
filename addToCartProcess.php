...
if(isset($_GET["id"])){
    ...
    if($cart_num == 1){
        ...
        if($product_qty >= $new_qty){
            ...
            Database::iud("UPDATE `cart` SET `qty`='".$new_qty."' WHERE `product_id`='".$pid."' AND `users_email`='".$umail."'");
        ...
        Database::iud("INSERT INTO `cart`(`product_id`,`users_email`,`qty`) VALUES ('".$pid."','".$umail."','1')");
